...
describe('Header Navigation Tests', () => {
    ...
    it(`TC11 Header ${header.products.menuName} menu Validation`, async () => {
    ...
    it(`TC12 Header ${header.solutions.menuName} menu Validation`, async () => {
        await homePage.clickMenuToggleButton();
    ...
    it(`TC13 Header ${header.pricing.menuName} menu Validation`, async () => {
        await homePage.clickMenuToggleButton();
    ...
    it(`TC14 Header ${header.whyTelnyx.menuName} menu Validation`, async () => {
        await homePage.clickMenuToggleButton();
    ...
    it(`TC15 Header ${header.resources.menuName} menu Validation`, async () => {
        await homePage.clickMenuToggleButton();
    ...
    it(`TC16 Header ${header.developers.menuName} menu Validation`, async () => {
        await homePage.clickMenuToggleButton();
